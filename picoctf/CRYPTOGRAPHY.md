...
- [PyCryptodome docs (Crypto.Util.number)](https://pycryptodome.readthedocs.io/en/latest/src/util/util.html)
- [gmpy2 — fast big integer math library](https://pypi.org/project/gmpy2/)
...
> **(repeat / template for your next writeup)**
...
- Steps, shell commands and thought process
...
*Instructions for images / screenshots:*
- Where I reference server replies and screenshots, you can replace the placeholder text with your actual screenshots.
- To include screenshots in this markdown file, create a `screenshots/` folder next to this `.md` and add files named `step1.png`, `step2.png`, etc. Then replace the relevant lines with `![step1](screenshots/step1.png)` to show them in the report.
